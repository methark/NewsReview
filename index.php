...
$ageWindowHours = $result['age_window_hours'];
$runDuration = $result['run_duration'];
$categoryArticleCount = $result['category_article_count'];
$candidateArticleCount = $result['candidate_article_count'];
...
<header class="site-header">
    <div class="header-inner">
        ...
        <p class="run-meta">
            ...
            &middot; <?= $categoryArticleCount ?> articles scanned across <?= count($filteredSources) ?> outlets
            <?php if ($selectedCategories !== $validCategories): ?>
            (<?= h(implode(', ', array_map('ucfirst', $selectedCategories)) ?: 'none selected') ?>)
            <?php endif; ?>
            <?php if ($searchQuery !== ''): ?>
            &middot; <?= $candidateArticleCount ?> match &ldquo;<?= h($searchQuery) ?>&rdquo;
            <?php endif; ?>
